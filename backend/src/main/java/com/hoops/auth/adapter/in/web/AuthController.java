...
public class AuthController {
    ...
    @Operation(summary = "Get Kakao auth URL", description = "Returns the Kakao OAuth authorization URL")
    ...
    @Operation(summary = "Handle Kakao callback", description = "Processes Kakao OAuth callback. Returns tokens for existing users, temp token for new users")
    @ApiResponses({
    ...
    @Operation(summary = "Sign up", description = "Completes signup for new users")
    @ApiResponses({
