...
| 날짜 | 작업 | PR |
|------|------|-----|
| 2026-01-15 | 참가 취소 후 재신청 기능 구현 (CANCELLED → PENDING 재활성화) | - |
| 2026-01-15 | 비즈니스 로직 문서화 (장소-매치 중복 정책, 참가 규칙) | - |
| 2026-01-13 | 프론트엔드 P0 비즈니스 규칙 UI 적용 | #23 |
| 2026-01-13 | P0 비즈니스 규칙 구현 (취소 시간 제한, 취소 사유 필수, 시간 겹침 제한) | #22 |
| 2026-01-13 | CLAUDE.md 개발 규칙 추가 | - |
...
| DELETE | `/api/matches/{matchId}` | 경기 취소 (사유 필수, 2시간 전까지) |
