-- =====================================================
-- Hoops 프로젝트 전체 스키마 (개발용)
-- Description: 전체 테이블 생성 스크립트 (Flyway 미사용 환경)
-- =====================================================

-- Database 생성 (선택사항)
-- CREATE DATABASE IF NOT EXISTS hoops DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- USE hoops;
